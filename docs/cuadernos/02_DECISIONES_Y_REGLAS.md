...
### JCP-DEC-044 — Métricas de mesa 63:88 y U=72 para el greybox — vigente para presentación

Fuente de esta revisión: encargo explícito del diseñador del 2026-09-12; S00 y S01 siguen aportando las zonas y la autoridad de reglas. Los números 040–043 no aparecen en esta copia local y no se atribuye aquí contenido a revisiones remotas no descargadas.

La referencia inicial de escritorio es 1600×900, con U=72 px y proporción de carta 63:88. En el campo, Ataque mide 72×101 y Guardia 101×72, ambos centrados en una envolvente de 101×101; cinco envolventes y cuatro separaciones de 11 px ocupan 549 px. Las filas reservan 105 px. Mano propia y rival usan cartas idénticas de 86×120 en filas de 124 px y paso horizontal de 94, 76, 60 o 48 px según haya hasta cinco, hasta siete, hasta nueve o diez o más cartas. La ficha lateral mide 180×251; las zonas auxiliares 60×90 y quedan a 16 px del núcleo. HUD de jugador 33 px, banda de fases 26 px y rail contextual aproximadamente 274 px.

Esto cambia solo presentación, no reglas ni autoridad de `UniversalCardEngine`. El Territorio puede conservar su formato especial. Los demás tamaños no volverán a introducirse como valores arbitrarios aislados. Otras resoluciones deberán escalar después desde la misma unidad o adoptar layout responsive; la referencia 1600×900 no equivale todavía a compatibilidad total con cualquier pantalla.

### JCP-DEC-045 — Perspectiva oblicua de jugador sentado para la mesa greybox — vigente para presentación

Referencia de composición solicitada por el diseñador el 2026-09-12: sensación espacial tipo *Yu-Gi-Oh Tag Force*, con *Dawn of Destiny* como apoyo para la profundidad, sin copiar sus imágenes ni su identidad gráfica. S00 y S01 mantienen la autoridad sobre zonas, fases e interacción mecánica; no fijan la cámara ni los factores visuales.

Se sustituye expresamente el encuadre casi cenital y la igualdad de escala visual de JCP-DEC-039. El tapete 2D se representa como un trapecio moderado: borde inferior próximo y ancho, borde superior lejano y estrecho, líneas internas discretas. Las cartas nominales de JCP-DEC-044 no cambian de dimensiones de diseño ni se deforman; la mano y el campo propios se renderizan al 100 %, la mano rival al 90 %, su campo al 92 % y el eje de fases al 95 %. La reducción lejana es intencional y debe conservar legibilidad y clics sobre zonas legales. HUD rival más estrecho que el propio refuerza el punto de vista.

La cabecera normal prioriza Combate, terminar turno, rival IA y nueva partida. Vista, cortina 2P y semilla permanecen accesibles en Herramientas. El estado superior se reduce a turno/fase/contexto y el rail derecho solo despliega detalle amplio cuando hay selección. Todo ello es presentación: no modifica `UniversalCardEngine`, reglas, privacidad, IA, Fusión, replay, persistencia ni las acciones legales. La legibilidad en otras resoluciones sigue pendiente de una fase responsive.

### JCP-DEC-046 — La perspectiva interna sigue la profundidad de la mesa — vigente para presentación

Fuente: encargo explícito del diseñador del 2026-09-12; S00/S01 delimitan únicamente las zonas y reglas, no la geometría visual. La perspectiva exterior de JCP-DEC-045 ya era aceptable, pero un ancho único de 549 px para las cuatro filas hacía que las casillas pareciesen un grid plano superpuesto al tapete. Se conserva el trapecio exterior y la escala moderada; cada fila del campo obtiene su propio ancho útil, de 549 px en apoyo rival a 625 px en apoyo propio, pasando por criatura rival 570 px y criatura propia 590 px. Las cinco envolventes se distribuyen sobre ese ancho, con 11 px como separación nominal mínima, y Territorio, Fusión, Baraja y Cementerio se anclan al borde útil de su fila, no al de un grid global. Las cartas siguen rectangulares, legibles y con los tamaños nominales de JCP-DEC-044; las posiciones continúan siendo equivalentes. Esta decisión sustituye solo la geometría uniforme de filas descrita en JCP-DEC-044 y no cambia ninguna regla ni contrato de interacción.

### JCP-DEC-047 — Proyección visual real de piezas y fase fuera del campo — vigente para presentación

Fuente: corrección explícita del diseñador del 2026-09-12. S00/S01 se consultan solo para preservar zonas y fases reglamentarias; no prescriben la forma gráfica. JCP-DEC-045/046 resolvían el contorno y la distribución, pero no la forma de las piezas: un botón frontal de 72×101 sobre un tapete trapezoidal seguía pareciendo una interfaz superpuesta. Se conserva el trapecio exterior y la posición general. Las veinte casillas, las cartas efectivamente jugadas en Ataque o Guardia y las ocho zonas laterales se dibujan mediante cuadriláteros proyectados sobre el plano; el `Button`/`CardTile` nominal permanece invisible como hitbox para conservar clic, privacidad, selección y objetivos. La mano propia continúa frontal; la rival permanece legible al fondo. Las dimensiones 72×101 y 101×72 de JCP-DEC-044 son hitboxes/base de composición, no siluetas frontales obligatorias del campo. Esta cláusula sustituye la interpretación de “cartas sin deformación” de JCP-DEC-045 y la frase “cartas siguen rectangulares” de JCP-DEC-046 exclusivamente para cartas sobre la mesa. Las seis fases mecánicas siguen intactas, pero su banda visual sale del centro: solo se muestra la fase actual en la cabecera. No cambia reglas, UCE, IA, replay, persistencia ni contratos de interacción.

### JCP-DEC-048 — Geometría de campo fijada por plantilla medida 1280×720 — vigente para presentación

Fuente: las cuatro bandas y veinte centros medidos entregados expresamente por el diseñador el 2026-09-12. S00/S01 se consultan únicamente para conservar zonas, fases y acciones; no fijan coordenadas. Se abandona el ajuste visual a ojo de anchos independientes de JCP-DEC-046/047: la geometría vigente del campo es una plantilla única 1280×720 con bandas en y=197–245, 250–308, 355–433 y 440–537, cuyos centros C1–C5 son los veinte puntos del encargo. Una escala uniforme `min(board_width/1280, board_height/720)` y una traslación común llevan toda la malla al tablero disponible, alineando el eje C3 con su centro. La traslación vertical mínima mantiene la costura central del fondo existente entre las bandas rivales y propias, sin cambiar una sola coordenada de la plantilla. Cada casilla y carta proyectada se obtiene como franja interpolada de su banda, no como trapecio autónomo; Fusión/Territorio y Baraja/Cementerio extrapolan los mismos bordes laterales y la misma profundidad. Las hitboxes, manos, preview, fondo externo, fase superior y contratos de interacción se conservan. Solo cambia presentación, no reglas, UCE, IA, privacidad, replay, persistencia ni Fusión.

### JCP-DEC-049 — Respaldo de emergencia de la geometría válida y fondo negro temporal — vigente para presentación

Fuente: encargo explícito del diseñador del 2026-09-13. La geometría de JCP-DEC-048 se congela como base válida antes de cualquier cambio visual: commit local `9f4ddd4`, etiqueta local `mesa_perspectiva_ok_v1` y copia física verificada en `artifacts/backup_mesa_perspectiva_ok_v1/`. No se hizo pull, descarga de ramas ni merge. Esta pasada cambia exclusivamente los tres rellenos verdes de `demo/duel_table_backdrop.gd` a negros/grises casi negros muy próximos entre sí, para quitar la sensación de rampa. El fondo es temporal para futuros escenarios o decoraciones, no un rediseño autorizado. Permanecen intactos el trapecio, las coordenadas, cuatro bandas, veinte centros, perspectiva de piezas, manos, rail, cabecera, fase arriba, dimensiones e interacción. No modifica ninguna regla ni la autoridad de UCE. En esta fase, cualquier nuevo cambio visual de la mesa debe empezar por un respaldo de emergencia identificable.

### JCP-DEC-050 — Gramática UX unificada y primer flujo criatura → destino → modo → COMMIT — vigente para interacción

Fuente: encargo explícito del diseñador del 2026-09-13. Se introduce un estado pequeño y reutilizable `IDLE / SOURCE_SELECTED / TARGET_SELECTION / MODE_SELECTION`, con fuente, acciones candidatas, destinos legales, modo pendiente y cancelabilidad. Solo cubre por ahora la invocación de criaturas desde la mano. El primer clic selecciona y muestra posibilidades, pero nunca muta. La autoridad legal y la única mutación pertenecen a la acción existente de UCE, consultada de nuevo en el COMMIT. Clic-clic y arrastre son dos entradas hacia ese mismo estado y comando. Escape, clic vacío, cambio de carta y arrastre inválido no mutan; los dos primeros cancelan, el cambio sustituye selección. El bloqueo de Terminar turno durante una invocación incompleta fue la decisión original, sustituida expresamente por JCP-DEC-053. Con Ataque y Guardia legales, un menú pequeño junto al destino elige el modo y ese clic hace COMMIT; con un modo único, el clic de destino hace COMMIT sin menú. Después se vuelve a `IDLE`. No se implementan aún los demás flujos de ataque, magia, equipo, trampas, respuesta o Fusión. La geometría, perspectiva, posiciones, reglas, privacidad y UCE permanecen congeladas.

### JCP-DEC-051 — Respuesta a prueba humana: selección rápida y acciones comprensibles — vigente para interfaz

Fuente: problemas concretos comunicados por el diseñador el 2026-09-13; S01/S04 conservan la autoridad sobre mecánicas. Las acciones legales de UCE se memorizan únicamente dentro de la misma versión de estado y vista de jugador, con invalidación al comenzar/cargar partida. La interfaz muestra el estado de selección y el resultado de acciones incluso cuando tienen éxito; explica objetivo obligatorio para magia dirigida, diferencia magia persistente y respuesta preparada, indica Combate/primer turno para atacar y dos materiales propios compatibles para Fusión. No se infiere que una carta concreta esté correcta sin conocer su identidad: la incidencia individual queda abierta. No cambia costes, ventanas, resolución, receta, fase, IA, privacidad, geometría ni color.

### JCP-DEC-052 — Ataque directo desde cartas y distinción visible de mejoras — vigente para interfaz

Fuente: segunda prueba humana explícita del diseñador del 2026-09-13; reglas existentes de S01 sobre fases, ataque, magia persistente y equipo. Se sustituye para la mesa normal el requisito de pulsar «Ir a Combate» descrito en JCP-DEC-038/039/051: en Principal 1, seleccionar una criatura propia y pulsar un objetivo rival legal entra automáticamente en Combate y declara el ataque mediante las dos acciones UCE ordinarias. El primer turno, Guardia, Fusión recién formada y demás restricciones legales siguen vigentes; no se abre Combate para el ataque prohibido del primer turno. El mando superior de Principal 1 sirve solo para pasar sin atacar hacia Principal 2; en Combate sirve para cerrarlo. G04 otorga automáticamente +1 DEF a todas las criaturas propias en Guardia mientras esté activa, G05 espera su disparador y E04 es un artefacto para trasladar equipo ya vinculado: no se asignan a una criatura. E02 y los demás equipos compatibles se vinculan eligiendo una criatura al jugarlos y aplican su efecto de inmediato. Estas diferencias deben aparecer en la interfaz, no requerir un manual. No se cambian reglas, costes, ventanas, geometría, perspectiva, IA, privacidad ni UCE.

### JCP-DEC-053 — Terminar turno no queda bloqueado por una selección incompleta — vigente para interfaz

Fuente: incidencia y captura de la prueba humana del 2026-09-13; S01 conserva la prioridad de respuesta y las fases. Sustituye expresamente la cláusula de bloqueo de JCP-DEC-050: «Terminar turno» permanece disponible aunque esté a medias la selección de una carta, casilla o postura. Al confirmar, la intención incompleta se descarta sin ejecutar carta ni gastar recursos, y el turno avanza mediante las acciones legales ordinarias. Si hay una ventana de respuesta y el jugador tiene prioridad, ese control pasa a llamarse «Pasar respuesta» y envía `pass_reaction`; no se salta una respuesta del rival ni se termina su turno. Si la prioridad es del rival, se muestra «Esperando respuesta». La confirmación de fin de turno no fuerza una transición ilegal durante una ventana abierta. No cambian reglas, motor, geometría, IA ni privacidad.

### JCP-DEC-054 — Fusión por arrastre o dos clics, con confirmación de resultado y pago — vigente para interfaz

Fuente: aprobación del diseñador del 2026-09-14; S04, regla operativa 5, y JCP-DEC-018/023 fijan que la Fusión normal actual no tiene coste universal de Energía. Una criatura propia visible puede arrastrarse sobre otra criatura propia; solo las parejas que figuren en `get_legal_actions()` se iluminan y admiten entrega. Los dos clics conservan la misma ruta. La entrega o segundo clic no muta: presenta resultado, postura, objetivo si procede y «0 Energía» para confirmar o cancelar. La acción exacta sigue siendo de UCE. El coste de referencia del perfil resultante no se rotula como pago. Variantes futuras de una misma pareja con otro efecto o coste quedan pendientes de diseño: deben corresponder a recetas o condiciones con sentido mecánico explícito, no a una mera preferencia estética. No se altera el límite de Fusión ni se añaden recetas, pagos o reglas.

### JCP-DEC-055 — Frontal numérico provisional de las cartas — vigente para presentación

Fuente: petición explícita del diseñador del 2026-09-14; S01 fija que las criaturas tienen coste, ATQ y DEF, y S02 sirve de referencia provisional para sus cifras, pero ninguna fuente fija aún una iconografía final. La carta visible de mano y su ficha ampliada deben imprimir nombre, tipo, elemento, coste numérico de Energía, ATQ y DEF; la ampliación muestra también el texto de efecto. Se toman los valores de la definición visible y, en campo, las estadísticas efectivas. Una Fusión puede mostrar su coste de referencia con el rótulo `REF`, nunca como pago de su acción normal (0 Energía según JCP-DEC-054). Se reserva el área de ilustración, sin dibujar arte definitivo ni copiar marcas o composición exacta de otros juegos. La mano oculta del rival no revela estos datos. Coste en símbolos/puntos, tratamiento de nombres largos y arte final quedan para otra iteración. No cambia reglas, catálogo, geometría, tamaño, UCE, IA ni privacidad.

### JCP-DEC-056 — Semilla nueva en cada partida humana, con repetición explícita — vigente para la mesa

Fuente: prueba humana y petición del diseñador del 2026-09-14; S01, «PRIMER MAZO GENERALISTA DE PRUEBA», fija provisionalmente dos mazos didácticos de 40 cartas con la misma composición, no mazos construidos aleatoriamente. El motor ya baraja cada mazo de forma independiente y determinista según una semilla. La mesa dejará de reutilizar siempre `210921`: al abrirse y en «Nueva partida» obtiene una semilla nueva y distinta de la inmediatamente anterior. Herramientas muestra la semilla vigente y permite jugar una introducida para repetir con exactitud el reparto. Las pruebas pueden fijar una semilla inicial sin introducir comportamiento aleatorio en sus expectativas. La aleatoriedad modifica el orden y las manos, no las identidades, cantidades, recetas, reglas, IA, privacidad, replay ni persistencia. La oportunidad de Fusión temprana puede variar; garantizarla exigiría otro diseño de mazos o un escenario didáctico separado.

### JCP-DEC-057 — Acciones contextuales junto a criatura de campo — vigente para interfaz

Fuente: aprobación explícita del diseñador del 2026-09-14 y aclaración posterior; S01 («CAMBIO VOLUNTARIO DE POSTURA») mantiene sus límites de fase, turno de entrada, uso por turno y ataque previo. Al pulsar una criatura propia en el campo aparece junto a ella un menú pequeño con «Atacar» y «Pasar a Guardia/Ataque». Solo los comandos legales de UCE están habilitados: «Atacar» inicia la selección visual de objetivos legales; «Cambiar postura» ejecuta directamente el comando legal. El clic rápido criatura → objetivo visible continúa admitido. El lateral conserva ficha e información, pero deja de duplicar el cambio voluntario como acción principal. La elección de Ataque o Guardia al invocar permanece en su menú previo a la entrada. La frase del diseñador sobre impedir Guardia mediante cartas o habilidades expresa futuras excepciones deseadas, no elimina en esta pasada los límites ya cerrados de S01 ni implementa cartas de prohibición. No cambian reglas, UCE, IA, privacidad, geometría ni contenido.

### JCP-DEC-058 — Un resultado, dos posturas; respuesta trivial automática — vigente para interfaz

Fuente: prueba humana y capturas del diseñador del 2026-09-14; S01 («MECÁNICA 04/05» y «MECÁNICA 09») para resolución de igualdad, prioridad y fases; S04 para identidad única de cada receta. Una misma criatura o Fusión con variantes técnicas por postura y objetivo se presenta una sola vez: primero Ataque/Guardia y después, si corresponde, el objetivo de entrada. Los comandos UCE exactos se mantienen como fuente legal y la confirmación ejecuta solo uno. En partida contra IA, si la prioridad de respuesta vuelve al humano y sus únicas acciones son pasar o rendirse, la mesa envía automáticamente `pass_reaction`; cualquier reacción/elección real conserva control humano. No se automatiza el modo local para dos personas. Los resultados de combate muestran las dos comparaciones ATQ>DEF y el daño a Vida, sin inventar destrucción por empate ATQ=ATQ. Combate sigue siendo fase interna para ataques sucesivos de criaturas individuales; el mando visual «Pasar ataques» sale de ella cuando el jugador lo elige, y Terminar turno continúa disponible fuera de respuestas. No cambia S01, UCE, recetas, privacidad, geometría ni la IA rival.

### JCP-DEC-059 — Ficha secuencial de activaciones públicas — vigente para interfaz

Fuente: observación y captura de partida del diseñador del 2026-09-14; S01 («VISIBILIDAD DE CARTAS», «MECÁNICA 04» y cadena de respuestas) confirma que una carta preparada permanece oculta y que su activación ya es pública. La mesa presenta cada Magia o Trampa activada mediante su frontal ampliado, texto funcional y una pausa visual de cuatro segundos, con botón de avance inmediato. Si aparecen varias, conserva el orden de eventos. El rival automático y el pase trivial de JCP-DEC-058 esperan la presentación antes de actuar de nuevo. Solo `get_events(..., viewer_id)` permite anunciar una identidad; la definición estática del mazo aporta el texto, nunca la mano oculta ni el estado privado bruto. `support_set` no anuncia nada; la resolución posterior de una misma Magia principal no duplica su anuncio. Este ritmo es exclusivamente visual: prioridad, cadena LIFO, efectos, costes, fases, persistencia y reglas permanecen intactos. E03 sigue requiriendo Manipulador y solo puede equiparse en su ventana legal.

### JCP-DEC-060 — Equilibrio medido antes de retocar el primer mazo — vigente para evaluación

Fuentes: S01 («PRIMER MAZO GENERALISTA DE PRUEBA»), S02 (presupuesto provisional) y S04 (coste de preparación de Fusiones); encargo del diseñador del 2026-09-14/15. La primera baraja conserva por ahora sus 40 cartas, cifras, costes, efectos y reglas. Se instrumentan partidas completas de 30 vidas con las dos copias idénticas del mazo, semillas reproducibles y políticas emparejadas con ambos jugadores iniciales. Se registran inicio, desenlace, duración, acciones, cartas vistas y cartas jugadas. Los resultados de bots sirven para detectar problemas de consistencia y generar hipótesis; no demuestran la potencia causal de una carta ni sustituyen partidas humanas. No se cambiará una cifra, coste o efecto por una única partida, por una fórmula S02 o por una correlación de bot. Los guardados humanos terminados pueden resumirse localmente sin publicar manos, barajas ni el historial completo. Cualquier ajuste posterior requerirá evidencia concreta, comparación con su tramo de coste y una comprobación A/B reproducible que cambie una dimensión cada vez; una regla menor requerirá además justificar que la partida muestra un fallo real y documentar la nueva decisión. Esta decisión es de método, no de reglamento jugable.

### JCP-DEC-061 — Corpus oficial S00–S05 y reconciliación obligatoria antes del Atlas — vigente para diseño

La fuente editable oficial es la carpeta de Drive `JUEGO_CARTAS_PROPIO`, ID `1m54Q-WmufRhdVleWMq6mTwUbP3Nzxqcl`, con S00 método/estado, S01 mecánicas, S02 presupuesto provisional, S03 familias/elementos/taxonomía, S04 Fusiones y S05 personajes especiales. No se confundirá con `Juego de cartas original — Diseño y reglas`. Antes de crear o ampliar el Atlas se contrastará cualquier nombre, familia, superfamilia, elemento, anatomía, disciplina, aptitud, propiedad derivada, receta, cifra o habilidad con estas seis fuentes y con el informe `AUDITORIA_RECONCILIACION_DRIVE_CONTENIDO_LOCAL_V0_1.md`. El contenido local reciente no se borra ni se declara canon automáticamente: conserva estado de propuesta hasta resolver los elementos marcados `CONFLICTO_CON_DRIVE` o `REQUIERE_DECISIÓN_HUMANA`. Esta decisión registra autoridad y método; no cambia por sí misma ninguna regla o dato jugable.

### JCP-DEC-062 — GitHub `main` como referencia compartida del estado local reconciliado — vigente para repositorio

Fuente: instrucción explícita del diseñador del 2026-09-15. En esta sincronización, el árbol local actual de `F:/Taller de Juegos Zapity/juego_cartas_propio/engine` es la versión que se publica en el repositorio existente `danielmariabardillo1412-creator/juego-de-carta-propio-`. Antes de actualizar `main`, el estado remoto anterior `b0cc5dad3b2d35193c4626be966518964ccaf3f8` queda protegido por `backup/pre_sync_local_actual_20260915`. Se preservan el historial y `.git`; no se reintroducen archivos remotos obsoletos ni se suben cachés, importaciones PNG, temporales, secretos o copias físicas de emergencia. Se versionan los `.gd.uid` para mantener IDs estables de recursos de Godot. Esta decisión es de custodia y publicación, no altera las decisiones de diseño S00–S05, el motor ni el proyecto Zapity principal.


### JCP-DEC-063 — La primera prueba humana exige presentación mínima y onboarding no procedural — vigente para validación

Fuente: corrección explícita del diseñador del 2026-09-19 tras cerrar UX automatizable. Una build técnicamente funcional no se considera apta para validación humana si un tester externo recibe un greybox que no permite distinguir cartas, zonas y estados sin contexto previo. Antes de medir UX #13 debe existir una capa mínima de presentación: identidad visual provisional por carta/tipo, jerarquía legible de nombre/tipo/elemento/coste/estadísticas, rótulos inequívocos de zonas y un onboarding breve de reglas. Ese onboarding puede explicar objetivo, vocabulario, tipos de carta, zonas, posturas, prioridad y Fusión, pero no debe enseñar la secuencia exacta de clics que se pretende validar. La capa puede ser procedural/provisional y no constituye arte final. Debe permanecer fuera de UCE, no cambiar reglas, balance, privacidad, geometría ni comandos legales, y no bloquear suites GUI cuando la mesa se instancia como componente de test. La primera sesión humana se ejecutará sobre `main @ afa92a02d7a1397ff8e0481408f11e173c61a1aa`; primero guía, después juego libre sin ayuda procedural y finalmente H1–H7 solo para cubrir mecánicas no observadas. El balance sigue prohibido hasta registrar esa evidencia.
